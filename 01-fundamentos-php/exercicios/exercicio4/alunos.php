<?php
    /* Crie um programa que leia o array e liste cada um dos alunos contendo RA, Nome e Nota.
        Aplique um verificador para que informe se o aluno foi aprovado ou reprovado com base na nota.
    */
